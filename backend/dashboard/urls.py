...
urlpatterns = [
    ...
    path('group/<str:pk>/',GroupChangeAPI.as_view()),
    path('groupeventschange/<str:pk>/',AllEventsForGroupChangeAPI.as_view()),
    path('individualeventschange/<str:pk>/',AllEventsForUserChangeAPI.as_view()),
